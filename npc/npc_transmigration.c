...
#ifdef _ANGELOPEN   //yang ADD 精靈召喚判斷開關
...
#ifdef _PET_TRANS
#ifdef _PROSK99
	int endevflg[]={69,70,71,72,109,118,122,131,127,158,159,181
	#ifdef _Eventlock  		  	    //yang ADD 只能做一次的任務
	,getendevent(0),getendevent(1),getendevent(2),getendevent(3),getendevent(4),
	getendevent(5),getendevent(6),getendevent(7),getendevent(8),getendevent(9)
	#endif
	};//181:白狼獎品
#else
	int endevflg[]={69,70,71,72,109,118,122,131,127,158,159,-1};
#endif	
	int nowevflg[]={69,70,71,72
	#ifdef _Eventlock  		  	    //yang ADD 只能做一次的任務
	,getnowevent(0),getnowevent(1),getnowevent(2),getnowevent(3),getnowevent(4),
	getnowevent(5),getnowevent(6),getnowevent(7),getnowevent(8),getnowevent(9)
	#endif
	};
#endif
#ifdef _TRANS_6
