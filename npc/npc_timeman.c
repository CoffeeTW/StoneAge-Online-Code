...
enum {
	...
	E_INT_GRAPHIC2 = CHAR_NPCWORKINT2,		/*   身  の  像 */
...
static NPC_TimeMan	TimeTble[] = {
	...
	{"ALLNIGHT",	NICHIBOTU+1,	YOAKE}, 	/* 太  が出ていない時 */
	{"ALLNOON",		YOAKE+1,		NICHIBOTU},/* 太  が出ている時 */
	{"AM",			YONAKA+1,		SHOUGO}, 	/* AM 時のみ */
	{"PM",			SHOUGO+1,		YONAKA}, 	/* PM 時のみ */
	{"FORE",		YOAKE+1,		SHOUGO},	/* 太  がでてから正午まで */
	{"AFTER",		SHOUGO+1,		NICHIBOTU},/* 正午から太  が沈むまで */
	{"EVNING",		NICHIBOTU+1,	YONAKA}, 	/* 太  が沈んでから真    まで */
	{"MORNING",		YONAKA+1,		YOAKE}, 	/* 真    から太  が昇るまで */
	{"FREE",		0,				1024},
};
