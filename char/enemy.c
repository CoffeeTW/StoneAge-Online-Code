...
#undef	PARAM_CAL
	...
	CHAR_setInt( petindex, CHAR_FUSIONRAISE, getEggfeed()); //yang ADD 自定義餵蛋次數40為破蛋次數
...
#ifdef _PET_TRANS
int GetNewPet( int toindex , int petindex, int array, int *work)  //yang mark 寵物製造
{
    int     *p;
    int		tp[E_T_DATAINTNUM];
    int		tarray, i;
