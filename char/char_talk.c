...
static CHAR_ChatMagicTable CHAR_cmtbl[]={
	...
	{ "petlevelup",	CHAR_CHAT_DEBUG_petlevelup,	TRUE,	0,	2, "寵物欄號 等級 (帳號)"},
	{ "petexpup",	CHAR_CHAT_DEBUG_petexpup,	TRUE,	0,	2, "寵物欄號 經驗 (帳號)"},
	{ "help",			CHAR_CHAT_DEBUG_help,				TRUE,	0,	1, "指令/all"},
#ifdef _EQUIT_NEGLECTGUARD
	{ "setneguard",		CHAR_CHAT_DEBUG_setneguard,			TRUE,	0,	3, "waei"},
#endif
	//人物屬性
	{ "info",			CHAR_CHAT_DEBUG_info,			TRUE,	0,	1, "數值"},
	{ "level",			CHAR_CHAT_DEBUG_level,			TRUE,	0,	1, "數值 (帳號)"},
	{ "settrans",		CHAR_CHAT_DEBUG_setTrans,		TRUE,	0,	2, "數值 (帳號)"},
	{ "exp",			CHAR_CHAT_DEBUG_exp,			TRUE,	0,	2, "數值 (帳號)"},
	{ "hp",				CHAR_CHAT_DEBUG_hp,				TRUE,	0,	2, "數值 (帳號)"},
	{ "mp",				CHAR_CHAT_DEBUG_mp,				TRUE,	0,	2, "數值 (帳號)"},
	{ "setmp",			CHAR_CHAT_DEBUG_setmp,			TRUE,	0,	2, "數值 (帳號)"},
	{ "str",			CHAR_CHAT_DEBUG_str,			TRUE,	0,	2, "數值*100 (帳號)"},
	{ "dex",			CHAR_CHAT_DEBUG_dex,			TRUE,	0,	2, "數值*100 (帳號)"},
	{ "tgh",			CHAR_CHAT_DEBUG_tgh,			TRUE,	0,	2, "數值*100 (帳號)"},
	{ "vital",			CHAR_CHAT_DEBUG_vital,			TRUE,	0,	2, "數值*100 (帳號)"},
	{ "luck",			CHAR_CHAT_DEBUG_luck,			TRUE,	0,	2, "數值 (帳號)"},
	{ "superman",		CHAR_CHAT_DEBUG_superman,		TRUE,	0,	2, "(帳號)"},
	{ "dp",				CHAR_CHAT_DEBUG_dp,				TRUE,	0,	2, "數值 (帳號)"},
	...
	//系統
	{ "announce",		CHAR_CHAT_DEBUG_announce,		TRUE,	0,	1, "內容"},
	{ "loginannounce",	CHAR_CHAT_DEBUG_loginannounce,	TRUE,	0,	1, "內容"},
	...
	{ "metamo",			CHAR_CHAT_DEBUG_metamo,			TRUE,	0,	1, "變身圖號 (帳號)"},
  ...
  { "battleout",		CHAR_CHAT_DEBUG_battleout,		TRUE,	0,	1, "無"},
	...
	{ "warp",			CHAR_CHAT_DEBUG_warp,			TRUE,	0,	1, "地圖號 x y"},
  ...
  { "shutdown",		CHAR_CHAT_DEBUG_shutdown,		TRUE,	0,	3, "(分鐘)"},

	//製成
	{ "delitem",		CHAR_CHAT_DEBUG_delitem,		TRUE,	0,	1, "all/位置"},
	{ "delpet",			CHAR_CHAT_DEBUG_deletepet,		TRUE,	0,	1, "all/位置"},
	{ "additem",		CHAR_CHAT_DEBUG_additem,		TRUE,	0,	2, "道具ID ((數量) (帳號))"},
	...
	{ "set_schedule_time",CHAR_CHAT_DEBUG_set_schedule_time,TRUE,0,2,"時間 莊園ID 分鐘"},
#endif
	...
	{ "MM",		CHAR_CHAT_DEBUG_MM,      TRUE,   0,  3, "MM 1/2 (帳號)"},
#endif
#ifdef _GM_ITEM
	{ "gmfunction",		CHAR_CHAT_DEBUG_GMFUNCTION,      TRUE,   0,  3, "命令 次數 (帳號)"},
#endif

#ifdef _GM_RIDE
	{ "setride",		CHAR_CHAT_DEBUG_SETRIDE,      TRUE,   0,  3, "騎寵號 (帳號)"},
	{ "mvride",		CHAR_CHAT_DEBUG_MVRIDE,      TRUE,   0,  3, "騎寵號 (帳號)"},
#endif

#ifdef _LOCK_IP
	{ "addlock",		CHAR_CHAT_DEBUG_ADD_LOCK,      TRUE,   0,  3, "flag 帳號/IP IP"},
	{ "dellock",		CHAR_CHAT_DEBUG_DEL_LOCK,      TRUE,   0,  3, "flag 帳號/IP IP"},
	{ "showip",		CHAR_CHAT_DEBUG_SHOWIP,      TRUE,   0,  3, "帳號"},
#endif	
	{ "setfame",		CHAR_CHAT_DEBUG_SET_FAME,      TRUE,   0,  3, "帳號 聲望值"},
	
#ifdef _AUTO_PK
	{ "pktime",		CHAR_CHAT_DEBUG_SET_AUTOPK,      TRUE,   0,  3, "分鐘"},
#endif
...
#ifdef _TRANS
	{ "trans",		CHAR_CHAT_DEBUG_Trans,      TRUE,   0,  3, "(帳號)"},
#endif
#ifdef _FUSIONBEIT_FIX
	{ "fusionbeit",		CHAR_CHAT_DEBUG_fusionbeit,      TRUE,   0,  3, "寵物欄號 (帳號)"},
#endif
#ifdef _MAKE_PET_CF
	...
	{ "刪除地圖",		CHAR_CHAT_GetMap,      TRUE,   0,  3, ""},
	{ "獲取地圖",		CHAR_CHAT_GetMap,      TRUE,   0,  3, ""},
	{ "圖片對像",		CHAR_CHAT_Map,      TRUE,   0,  3, ""},
	{ "圖片",		CHAR_CHAT_Fixtile,      TRUE,   0,  3, ""},
	{ "對像",		CHAR_CHAT_Fixobj,      TRUE,   0,  3, ""},
//	{ "fukuwa",		CHAR_CHAT_Fukuwa,      TRUE,   0,  3, ""},
#endif
/////////////////////////////////////////////////////////////////////////
	//工程師專用
//	{ "programming_engineer",	CHAR_CHAT_DEBUG_engineer,	TRUE,	0,	3, ""},
	{ "寵物等級",	CHAR_CHAT_DEBUG_petlevelup,	TRUE,	0,	2, "寵物欄號 等級 (帳號)"},
	{ "寵物經驗",	CHAR_CHAT_DEBUG_petexpup,	TRUE,	0,	2, "寵物欄號 經驗 (帳號)"},
	{ "幫助",			CHAR_CHAT_DEBUG_help,				TRUE,	0,	1, "指令/all"},
#ifdef _EQUIT_NEGLECTGUARD
//	{ "setneguard",		CHAR_CHAT_DEBUG_setneguard,			TRUE,	0,	3, "waei"},
#endif
	//人物屬性
	{ "人物信息",			CHAR_CHAT_DEBUG_info,			TRUE,	0,	1, "數值"},
	{ "等級",			CHAR_CHAT_DEBUG_level,			TRUE,	0,	1, "數值 (帳號)"},
	{ "轉生",		CHAR_CHAT_DEBUG_setTrans,		TRUE,	0,	2, "數值 (帳號)"},
	{ "經驗",			CHAR_CHAT_DEBUG_exp,			TRUE,	0,	2, "數值 (帳號)"},
	{ "血",				CHAR_CHAT_DEBUG_hp,				TRUE,	0,	2, "數值 (帳號)"},
	{ "魔法",				CHAR_CHAT_DEBUG_mp,				TRUE,	0,	2, "數值 (帳號)"},
	{ "設置魔法",			CHAR_CHAT_DEBUG_setmp,			TRUE,	0,	2, "數值 (帳號)"},
	{ "腕力",			CHAR_CHAT_DEBUG_str,			TRUE,	0,	2, "數值*100 (帳號)"},
	{ "敏捷",			CHAR_CHAT_DEBUG_dex,			TRUE,	0,	2, "數值*100 (帳號)"},
	{ "耐力",			CHAR_CHAT_DEBUG_tgh,			TRUE,	0,	2, "數值*100 (帳號)"},
	{ "體力",			CHAR_CHAT_DEBUG_vital,			TRUE,	0,	2, "數值*100 (帳號)"},
	{ "運氣",			CHAR_CHAT_DEBUG_luck,			TRUE,	0,	2, "數值 (帳號)"},
	{ "超人",		CHAR_CHAT_DEBUG_superman,		TRUE,	0,	2, "(帳號)"},
	{ "dp",				CHAR_CHAT_DEBUG_dp,				TRUE,	0,	2, "數值 (帳號)"},
#ifdef _EQUIT_ARRANGE
	{ "格檔",		CHAR_CHAT_DEBUG_arrange,		TRUE,	0,	3, "數值"},
#endif

#ifdef _EQUIT_SEQUENCE
	{ "順序",		CHAR_CHAT_DEBUG_sequence,		TRUE,	0,	3, "數值"},
#endif

	//系統
	{ "公告",		CHAR_CHAT_DEBUG_announce,		TRUE,	0,	1, "內容"},
	{ "登陸公告",	CHAR_CHAT_DEBUG_loginannounce,	TRUE,	0,	1, "內容"},
	{ "系統信息",		CHAR_CHAT_DEBUG_sysinfo,		TRUE,	0,	1, ""},
	{ "地圖特效",			CHAR_CHAT_DEBUG_effect,			TRUE,	0,	1, "alloff/地圖號 特效"},
	{ "重讀",			CHAR_CHAT_DEBUG_reset,			TRUE,	0,	2, "enemy/encount/magic/warppoint/petskill/pettalk/npc/all"},
	{ "清除地圖物品",	CHAR_CHAT_DEBUG_cleanfloor,		TRUE,	0,	3, "地圖號"},
	{ "統計",		CHAR_CHAT_printcount,			TRUE,	0,	1, ""},
	{ "重讀寵物資料",	CHAR_CHAT_DEBUG_enemyrestart,	TRUE,	0,	3, "無"},
	{ "清除地上寵物",	CHAR_CHAT_DEBUG_cleanfreepet,	TRUE,	0,	3, "無"},
	
#ifdef _GMRELOAD
	{ "讀取GM設置",		CHAR_CHAT_DEBUG_gmreload,		TRUE,	0,	3, "all/cdkey level"},
#endif

	{ "踢除所有玩家",	CHAR_CHAT_DEBUG_waeikickall,	TRUE,	0,	3, "無"},
//	{ "checktrade",		CHAR_CHAT_DEBUG_checktrade,		TRUE,	0,	3, "waei"},
	//工具	初級GM
	{ "調試",			CHAR_CHAT_DEBUG_debug,			TRUE,	0,	1, "密碼 調試 on/off"},
	{ "造型",			CHAR_CHAT_DEBUG_metamo,			TRUE,	0,	1, "變身圖號 (帳號)"},
	{ "鎖定帳號",		CHAR_CHAT_DEBUG_checklock,		TRUE,	0,	1, "帳號"},
	{ "封嘴",			CHAR_CHAT_DEBUG_shutup,			TRUE,	0,	1, "帳號 ON/OFF"},
#ifdef _WAEI_KICK
	{ "gm踢人",			CHAR_CHAT_DEBUG_gmkick,			TRUE,	0,	1, "帳號 LSLOCK/KICK/DEUNLOCK/UNLOCKALL/LOCK/TYPE/UNLOCK"},
#endif
  { "加入戰鬥",		CHAR_CHAT_DEBUG_battlein,		TRUE,	0,	1, "無"},
  { "結束戰鬥",		CHAR_CHAT_DEBUG_battleout,		TRUE,	0,	1, "無"},
	{ "觀戰",	CHAR_CHAT_DEBUG_battlewatch,	TRUE,	0,	1, "無"},
	{ "顯示信息",		CHAR_CHAT_DEBUG_getuser,		TRUE,	0,	1, "人物名 地圖號 (npc)"},
	{ "傳送自己",			CHAR_CHAT_DEBUG_warp,			TRUE,	0,	1, "地圖號 x y"},
	{ "踢除玩家",		CHAR_CHAT_DEBUG_waeikick,		TRUE,	0,	1, "帳號"},
  { "關入監獄",			CHAR_CHAT_DEBUG_jail,			TRUE,	0,	1, "帳號"},
	{ "傳送",			CHAR_CHAT_DEBUG_send,			TRUE,	0,	1, "地圖編號 x y 帳號"},
#ifdef _SendTo
	{ "傳送到玩家",			CHAR_CHAT_DEBUG_Sendto,			TRUE,	0,	1, "帳號"},
#endif
	{ "不遇敵",		CHAR_CHAT_DEBUG_noenemy,		TRUE,	0,	1, "on/off"},
	{ "顯示完成任務",		CHAR_CHAT_DEBUG_watchevent,		TRUE,	0,	1, "無"},
#ifdef _SEND_EFFECT	   	        // WON ADD AC送下雪、下雨等特效
	{ "特效",		CHAR_CHAT_DEBUG_sendeffect,		TRUE,	0,	1, ""},
#endif
	{ "禁言",			CHAR_CHAT_DEBUG_silent,			TRUE,	0,	2, "帳號 分鐘"},//禁言
	{ "解鎖",			CHAR_CHAT_DEBUG_unlock,			TRUE,	0,	2, "帳號"},
	{ "清除旗標",		CHAR_CHAT_DEBUG_eventclean,		TRUE,	0,	2, "all/旗標 帳號 人物名"},
	{ "增加旗標",	CHAR_CHAT_DEBUG_eventsetend,	TRUE,	0,	2, "all/旗標 帳號 人物名"},
	{ "重新任務",	CHAR_CHAT_DEBUG_eventsetnow,	TRUE,	0,	2, "all/旗標 帳號 人物名"},

	{ "人物地區顯示",	CHAR_CHAT_DEBUG_playerspread,	TRUE,	0,	3, "waei"},
//	{ "shutupall",		CHAR_CHAT_DEBUG_shutupall,		TRUE,	0,	3, "無"},
	{ "解除服務器",	CHAR_CHAT_DEBUG_unlockserver,	TRUE,	0,	3, "無"},
  { "關服",		CHAR_CHAT_DEBUG_shutdown,		TRUE,	0,	3, "分鐘"},

	//製成
	{ "刪除物品",		CHAR_CHAT_DEBUG_delitem,		TRUE,	0,	1, "all/位置"},
	{ "刪除寵物",			CHAR_CHAT_DEBUG_deletepet,		TRUE,	0,	1, "all/位置"},
	{ "製作物品",		CHAR_CHAT_DEBUG_additem,		TRUE,	0,	2, "道具ID ((數量) (帳號))"},
	{ "製作寵物",		CHAR_CHAT_DEBUG_petmake,		TRUE,	0,	2, "寵物ID ((等級) (帳號))"},
	{ "金錢",			CHAR_CHAT_DEBUG_gold,			TRUE,	0,	2, "數量 (帳號)"},

	//家族工具
//	{ "manorpk",		CHAR_CHAT_DEBUG_manorpk,		TRUE,	0,	2, "allpeace/peace 莊園編號"},
	{ "修改族長",	CHAR_CHAT_DEBUG_fixfmleader,	TRUE,	0,	2, "帳號 1"},
	{ "修復家族PK",		CHAR_CHAT_DEBUG_fixfmpk,		TRUE,	0,	3, ""},
	{ "修復家族數據",		CHAR_CHAT_DEBUG_fixfmdata,		TRUE,	0,	2, ""},
	...
	{ "顯示倉庫項目",		CHAR_CHAT_DEBUG_ShowMyDepotItems,	TRUE,	0,	3, ""},
	{ "存入倉庫項目",	CHAR_CHAT_DEBUG_InSideMyDepotItems,	TRUE,	0,	3, ""},
#endif

#ifdef _CHAR_POOLPET
	{ "保存寵物",		CHAR_CHAT_DEBUG_savedpet,		TRUE,	0,	3, ""},
	{ "存入寵物",		CHAR_CHAT_DEBUG_insertdpet,		TRUE,	0,	3, ""},
	{ "顯示倉庫寵物",	CHAR_CHAT_DEBUG_ShowMyDepotPets,	TRUE,	0,	3, ""},
	{ "insidedepotpet",	CHAR_CHAT_DEBUG_InSideMyDepotPets,	TRUE,	0,	3, ""},
#endif


#ifdef _TEST_DROPITEMS
	{ "滿地寵物",		CHAR_CHAT_DEBUG_dropmypet,		TRUE,	0,	3, "寵物編號"},
	{ "滿地物品",		CHAR_CHAT_DEBUG_dropmyitem,		TRUE,	0,	3, "道具編號/(0/1)"},
#endif
#ifdef _CHAR_PROFESSION			// WON ADD 人物職業
	{ "添加技能",			CHAR_CHAT_DEBUG_addsk,			TRUE,	0,	2, ""},
	{ "刪除技能",			CHAR_CHAT_DEBUG_delsk,			TRUE,	0,	2, ""},
#endif
	{ "顯示時間",		CHAR_CHAT_DEBUG_checktime,		TRUE,	0,	3, ""},

#ifdef _GAMBLE_BANK
	{ "積分",	CHAR_CHAT_DEBUG_setgamblenum,	TRUE,	0,	3, "數值"},
#endif
    // WON ADD 當機指令
	{ "當機",			CHAR_CHAT_DEBUG_crash,			TRUE,	0,	3, ""},
#ifdef _PETSKILL_SETDUCK
//	{ "setDuck",		CHAR_CHAT_DEBUG_SetDuck,		TRUE,	0,	3, ""},
#endif
...
#endif
	{ "顯示內存",		CHAR_CHAT_DEBUG_showMem,		TRUE,	0,	2, "無"},
#ifdef _CHAR_PROFESSION			// WON ADD 人物職業
	{ "職業",		CHAR_CHAT_DEBUG_show_profession,TRUE,	0,	2, "restart/0/1 職業 等級"},
	{ "抗性",		CHAR_CHAT_DEBUG_set_regist,		TRUE,	0,  1, ""},
#endif
	{ "編碼",		CHAR_CHAT_DEBUG_samecode,		TRUE,	0,	3, "pet/item/set 編碼"},

#ifdef _NEW_MANOR_LAW
	// 設定個人氣勢
	{ "個人氣勢",CHAR_CHAT_DEBUG_set_momentum,TRUE,0,2,"[個人氣勢 <名稱> <數值>]"},
	// 設定家族擁有莊園
	{ "莊園",CHAR_CHAT_DEBUG_set_manor_owner,TRUE,0,2,"[莊園 <莊園id> <0 or 1> <家族名 or 家族ID>]"},
	// 設定莊園挑戰時間,設定的時間為目前每個挑戰時期的經過時間(單位:分),ex:現在是休戰期,共需要經過五天才會進
	// 入挑戰期,則下指令設定為 5 ,則會由五天的等待期變成了只等五分鐘
	{ "莊園挑戰時間",CHAR_CHAT_DEBUG_set_schedule_time,TRUE,0,2,"[set_schedule_time <id> <mm>]"},
#endif

#ifdef _ANGEL_SUMMON
	{ "精靈召喚",		CHAR_CHAT_DEBUG_angelinfo,		TRUE,   0,  2, ""},
	{ "清除精靈召喚",		CHAR_CHAT_DEBUG_angelclean,		TRUE,   0,  2, "任務編號"},
	{ "創建精靈召喚",	CHAR_CHAT_DEBUG_angelcreate,	TRUE,   0,  2, "使者帳號 勇者帳號 任務編號"},
	{ "重讀使者任務",	CHAR_CHAT_DEBUG_missionreload,	TRUE,   0,  2, ""},
#endif

	{ "讀取物品",	CHAR_CHAT_DEBUG_itemreload,	TRUE,   0,  2, ""},

	{ "天行者",	CHAR_CHAT_DEBUG_skywalker,	TRUE,   0,  1, ""},
#ifdef _ITEM_ADDEXP
	{ "讀取經驗物品",	CHAR_CHAT_DEBUG_itemaddexp,	TRUE,   0,  1, ""},
#endif
#ifdef _DEF_GETYOU	  
	{ "獲取帳號",		    CHAR_CHAT_DEBUG_getyou,			TRUE,   0,  1, "格數 1~3"},
#endif 
#ifdef _DEF_NEWSEND
	{ "傳送玩家",        CHAR_CHAT_DEBUG_newsend,        TRUE,   0,  1, "地圖編號 x y 帳號 無/要說的話"},   
#endif
#ifdef _DEF_SUPERSEND
	{ "群體傳送",      CHAR_CHAT_DEBUG_supersend,      TRUE,   0,  3, "地圖編號 x y 格數 無/要說的話"},   
#endif
#ifdef _FONT_SIZE
	{ "字體大小",		CHAR_CHAT_DEBUG_fsize,	TRUE,   0,  1, "字號"},
#endif
#ifdef _JOBDAILY
	{ "重新日誌",		CHAR_CHAT_DEBUG_rejobdaily,     TRUE,   0,  3, "無"},   
#endif
#ifdef _GM_ITEM
	{ "權限",		CHAR_CHAT_DEBUG_GMFUNCTION,      TRUE,   0,  3, "命令 次數 (帳號)"},
#endif

#ifdef _GM_RIDE
	{ "設置騎乘",		CHAR_CHAT_DEBUG_SETRIDE,      TRUE,   0,  3, "騎寵號 (帳號)"},
	{ "移除騎乘",		CHAR_CHAT_DEBUG_MVRIDE,      TRUE,   0,  3, "騎寵號 (帳號)"},
#endif

#ifdef _LOCK_IP
	{ "鎖定",		CHAR_CHAT_DEBUG_ADD_LOCK,      TRUE,   0,  3, "flag 帳號/IP IP"},
	{ "解除鎖定",		CHAR_CHAT_DEBUG_DEL_LOCK,      TRUE,   0,  3, "flag 帳號/IP IP"},
	{ "顯示玩家IP",		CHAR_CHAT_DEBUG_SHOWIP,      TRUE,   0,  3, "帳號"},
#endif
	{ "聲望",		CHAR_CHAT_DEBUG_SET_FAME,      TRUE,   0,  3, "帳號 聲望值"},
#ifdef _AUTO_PK
	{ "pk時間",		CHAR_CHAT_DEBUG_SET_AUTOPK,      TRUE,   0,  3, "分鐘"},
#endif

#ifdef _PLAYER_NUM
	{ "玩家數",		CHAR_CHAT_DEBUG_SET_PLAYERNUM,      TRUE,   0,  3, "人數"},
#endif
#ifdef _RELOAD_CF
	{ "讀取設置",		CHAR_CHAT_DEBUG_SET_RELOADCF,      TRUE,   0,  3, ""},
#endif
#ifdef _TRANS
	{ "高級轉生",		CHAR_CHAT_DEBUG_Trans,      TRUE,   0,  3, "(帳號)"},
#endif
#ifdef _FUSIONBEIT_FIX
	{ "融合寵",		CHAR_CHAT_DEBUG_fusionbeit,      TRUE,   0,  3, "寵物欄號 (帳號)"},
#endif
#ifdef _MAKE_PET_CF
	{ "寵物成長",		CHAR_CHAT_DEBUG_petmakecf,      TRUE,   0,  3, "寵物編號 轉物/等級/成長"},
#endif
		...
		if(messageeraseescape[0] == '/' && messageeraseescape[1] == 'g' && messageeraseescape[2] == 'o'){
			...
			if(point>getPMove() || getPMove()== 0 ){
				...
				CHAR_setInt( index , CHAR_AMPOINT, point-getPMove());
					...
					CHAR_talkToCli( index, -1,"你已經沒有足夠的會員點數順移了！", CHAR_COLORRED );
			return;
			}
		}
#endif
		...
		if(messageeraseescape[0] == '/' && messageeraseescape[1] == 'g' && messageeraseescape[2] == 'g'){
			...
			if(point>getPAnnounce() || getPAnnounce()== 0 ){
			  ...
			  CHAR_setInt( index , CHAR_AMPOINT, point-getPAnnounce());
				...
				CHAR_talkToCli( index, -1,"你已經沒有足夠的會員點數小喇叭了！", CHAR_COLORRED );
			return;
		}
	}
#endif
...
{
	if((CHAR_getFlg(index,CHAR_ISTELL) & CHAR_FS_SAVE) == TRUE){
		if(CHAR_getInt( index, CHAR_TRANSMIGRATION) >= 6 
			&& CHAR_getInt( index, CHAR_LV) >= 160){
			  int i;
			  int playernum = CHAR_getPlayerMaxNum();
			  for( i = 0 ; i < playernum ; i++) {
			    if( CHAR_getCharUse(i) != FALSE ) {
			       char token[256];
						 sprintf(token, "[世界] %s 說：%s", CHAR_getChar( index , CHAR_NAME), messageeraseescape);
