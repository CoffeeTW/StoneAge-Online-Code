...
}
{
		...
		if( strlen( token) > sizeof( TITLE_table[title_readlen].name)-1) {
			fprint("Äµ§i! ÀY»Î¦WºÙµ²§ô¤å¥ó:%s ²Ä%d¦æ\n",
					filename, linenum);
		}
	...
	print( "¦³®ÄÀY»Î¦WºÙ¼Æ¬O %d...", TITLE_titlenum );
...

{
	...
	print( "¦³®ÄÀY»Î°t¸m¼Æ¬O %d...", TITLE_titlecfgnum );
